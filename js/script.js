...
function calcular() {
  ...
  resultado.innerHTML += `<p class="lista">${qdtTotalCarne/1000} Kg de Carne</p>`
  resultado.innerHTML += `<p class="lista">${Math.ceil(qdtTotalCerveja/355)} latas de Cerveja</p>`
  resultado.innerHTML += `<p class="lista">${Math.ceil(qdtTotalBebidas/2000)} garrafas de Bebidas</p>`
}